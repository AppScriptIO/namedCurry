...
exports.curryNamed = curryNamed;
exports.curryNamedInvokeManually = curryNamedInvokeManually;
...
const includesEvery = (mandatory, received) => mandatory.every(key => received.includes(key));

const includesSome = (mandatory, received) => mandatory.filter(key => received.includes(key));